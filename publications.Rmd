...
```{r}
if(params$pdf_mode){
  cat("View this publications list online with links at _https://rhreynolds.github.io/cv/_")
} else {
  cat("[<i class='fas fa-download'></i> Download as a PDF](https://github.com/RHReynolds/cv/blob/main/docs/rhr_publications.pdf)")
}
```
